...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: FieldSet provides fieldset semantics; Field preserves the generic control-group API.
    <div
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      className={cn(
        "text-left font-normal text-muted-foreground text-sm/normal group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
