...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      className={cn(
        "text-pretty font-heading font-medium text-base/snug [&:not(:has(~[data-slot=questionnaire-description]))]:mb-4",
        className
      )}
...
function QuestionnaireDescription({
  ...
  return (
    <QuestionnairePrimitive.Description
      className={cn(
        "text-pretty text-base text-muted-foreground sm:text-sm",
        className
      )}
...
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      className={cn(
        "group/questionnaire-choice relative flex min-h-12 pointer-fine:min-h-11 cursor-pointer select-none items-start gap-2.5 rounded-lg border border-input bg-transparent px-3 py-2.5 text-start text-base outline-none hover:bg-muted/50 has-[>input:focus-visible]:border-ring has-[>input:focus-visible]:ring-3 has-[>input:focus-visible]:ring-ring/50 data-checked:border-primary/40 data-invalid:border-destructive data-checked:bg-muted sm:text-sm dark:bg-input/20 dark:data-checked:bg-muted",
  ...
  return (
    <QuestionnairePrimitive.Previous
      className={cn(
        ...
        "col-start-1 row-start-1 min-h-12 pointer-fine:min-h-0 justify-self-start",
        className
      )}
      data-size={size}
...
function QuestionnaireSkip({
  ...
  return (
    <QuestionnairePrimitive.Skip
      className={cn(
        buttonVariants({ size, variant }),
        "col-start-2 row-start-1 min-h-12 pointer-fine:min-h-0 justify-self-end",
        className
      )}
      data-size={size}
...
function QuestionnaireNext({
  ...
  return (
    <QuestionnairePrimitive.Next
      className={cn(
        buttonVariants({ size, variant }),
        "col-start-3 row-start-1 min-h-12 pointer-fine:min-h-0 justify-self-end",
        className
      )}
      data-size={size}
