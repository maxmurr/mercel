  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square size-full select-none rounded-(--cell-radius) p-0 text-center [&:last-child[data-selected=true]_button]:rounded-r-(--cell-radius)",
