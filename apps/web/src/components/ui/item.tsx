...
function ItemGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: Preserve the role-based list API for polymorphic children instead of imposing ul/li markup.
    <div
      className={cn(
...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "line-clamp-1 flex w-fit items-center gap-2 font-medium text-sm/snug underline-offset-4",
        className
      )}
